...
export default function WhatsAppButton() {
  return (
    ...
    >
      {/* Tooltip on hover */}
      <span className="hidden sm:inline-block mr-3 px-3 py-1.5 bg-sp-navy text-sp-ivory font-sans text-xs font-light tracking-wide border border-white/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none">
      ...
      <a
        ...
        className="relative flex items-center justify-center w-14 h-14 rounded-full bg-sp-sand text-sp-navy transition-transform duration-300 hover:scale-105 hover:bg-sp-ivory focus:outline-none focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-sp-sand"
      >
        {/* Subtle Ping Halo */}
